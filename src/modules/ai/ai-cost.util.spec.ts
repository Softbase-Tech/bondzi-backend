...
describe('costUsd', () => {
  ...
  it('prices cross-region inference profile IDs like the bare model ID', () => {
    ...
    expect(costUsd('eu.anthropic.claude-haiku-4-5-20251001-v1:0', 2000, 1000)).toBeCloseTo(
      costUsd(HAIKU, 2000, 1000),
      6,
    );
    expect(costUsd('us.anthropic.claude-sonnet-4-5-20250929-v1:0', 1000, 500)).toBeCloseTo(
      costUsd(SONNET, 1000, 500),
      6,
    );
  });
